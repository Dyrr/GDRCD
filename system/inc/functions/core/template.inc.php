   ...
   /**
    ...
    function renderHTML($template) {
        ...
        if(\template\is_ajax() === true) { 
            ...
            echo isset($template['content'])       ? $template['content']       : null;          
        
        //SE LA PAGINA È STATA RICHIESTA NORMALMENTE
        } else {
            
            //stampa tutta la pagina HTML
			echo isset($template['header'])        ? $template['header']        : null;   
			echo isset($template['layout_top'])    ? $template['layout_top']    : null;   
			echo isset($template['content'])       ? $template['content']       : null;   
			echo isset($template['layout_bottom']) ? $template['layout_bottom'] : null;   
			echo isset($template['footer'])        ? $template['footer']        : null;   
