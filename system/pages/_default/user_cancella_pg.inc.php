...
<div class="pagina_user_cancella_pg">
    ...
    <div class="page_body">
        ...
        if($_POST['op'] == 'delete') {
            if(($email == gdrcd_filter_email($_POST['email'])) && (\security\password\strength($_POST['new_pass']) === true)) {
                gdrcd_query("UPDATE personaggio SET permessi = -1 WHERE nome = '".$_SESSION['login']."' AND pass = '".\security\pass\hash($_POST['new_pass'])."'");
