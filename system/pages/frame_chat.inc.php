    ...
    <div class="page_body">
        ...
        if($allowance === false) {
            ...
            <div style="height: 0px; width: 100%">
                <iframe src="system/pages/chat.inc.php?ref=30&chat=yes" class="" id="chat_frame" name="chat_frame" frameborder="0" allowtransparency="true">
                </iframe>
            </div>
            ...
            <div class="panels_box">
                <div class="form_chat">
                    <!-- Form messaggi -->
                    <div class="form_row">
                        <form action="system/pages/chat.inc.php?ref=10&chat=yes" data-function="default" method="post" target="chat_frame" id="chat_form_messages">
                    ...
                    <?php if(($PARAMETERS['mode']['skillsystem'] == 'ON') || ($PARAMETERS['mode']['dices'] == 'ON')) { ?>
                        <div class="form_row">
                            <form action="system/pages/chat.inc.php?ref=30&chat=yes" data-function="default" method="post" target="chat_frame" id="chat_form_actions">
